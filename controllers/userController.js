...
const sendVerifyMail = async (username, email, id) => {
    try {
        ...
        const mailOptions = {
            ...
            html: '<p>Hi' + username + ', Plese click here to verify your Booky.com account <a href = "http://booky.fun/verify?id=' + id + '">Verify</a>your mail</p>'
        }
...
const sendResetPasswordMail = async (username, email, token) => {
    try {
        ...
        const mailOptions = {
            ...
            html: '<p>Hi ' + username + ', Plese click here to <a href = "http://booky.fun/forgotpassword?token=' + token + '">Reset</a>your password</p>'
        }
        transporter.sendMail(mailOptions, function (error, info) {
            if (error) {
                console.log(error);
